...
- ✅ mkdocs-Setup zentralisiert im Repo-Root (mkdocs.yml, tools/sync_docs.py, stylesheets) — Teil 4 wird über das Root-Setup gebaut
- 🚧 Kapitel 7 · `README.en.md` und `EXERCISES.en.md` (englische Übersetzung noch offen)
- ✅ Site-Deployment über GitHub Actions (`.github/workflows/deploy-docs.yml`) — automatisch bei Push auf `main`
...
- **Site-Deployment.** Die Site wird über den GitHub-Actions-Workflow `.github/workflows/deploy-docs.yml` im Repo-Root gebaut und bei jedem Push auf `main` automatisch auf GitHub Pages deployt. Ein lokales Deploy-Skript ist nicht mehr nötig.

...
- [`03_LanguageModelling/`](../03_LanguageModelling/) fragt: **Wie wurden moderne LLMs trainiert, ausgerichtet und skaliert?**
- [`04_AgenticSystems/`](./) fragt: **Wie werden diese Modelle als Agenten, Tool-Nutzer und Laufzeit-Systeme eingesetzt?**
...
### [`01_TextInTextOut/`](01_TextInTextOut/) — Was ein LLM aus API-Sicht wirklich ist
...
### [`02_ToolsAndPlanning/`](02_ToolsAndPlanning/) — Werkzeuge und der erste Plan
...
### [`03_TheLoop/`](03_TheLoop/) — Der externe Loop und was er kostet
...
### [`04_ReasoningInside/`](04_ReasoningInside/) — Der zweite Loop, unsichtbar
...
### [`05_ProtocolsAndScale/`](05_ProtocolsAndScale/) — MCP und A2A als lauffähige Miniaturen
...
### [`06_WhenNotToBuild/`](06_WhenNotToBuild/) — Das Urteil
...
### [`07_DynamicToolAgent/`](07_DynamicToolAgent/) — Der Agent, der seine eigenen Werkzeuge schreibt

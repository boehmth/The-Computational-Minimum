...
### [`01_TextInTextOut/`](01_TextInTextOut/) — What an LLM actually is, from the API side
...
### [`02_ToolsAndPlanning/`](02_ToolsAndPlanning/) — Tools and the first plan
...
### [`03_TheLoop/`](03_TheLoop/) — The external loop and what it costs
...
### [`04_ReasoningInside/`](04_ReasoningInside/) — The second loop, invisible
...
### [`05_ProtocolsAndScale/`](05_ProtocolsAndScale/) — MCP and A2A as runnable miniatures
...
### [`06_WhenNotToBuild/`](06_WhenNotToBuild/) — The verdict
...
### [`07_DynamicToolAgent/`](07_DynamicToolAgent/) — The agent that writes its own tools

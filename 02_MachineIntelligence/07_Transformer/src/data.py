...
#
#  Identisch zum Datensatz aus Meilenstein 6 (Seq2Seq).
#  So koennen wir den Transformer direkt gegen das Seq2Seq
#  vergleichen: gleiche Eingaben, gleiche Ziele - andere
#  Architektur.
#
#  Beispiel:
#     23  ->  ['drei', 'und', 'zwanzig']
...
def encode_output(n):
    """Wandelt eine Zahl in eine Sequenz [<sos>, w1, ..., <eos>]."""

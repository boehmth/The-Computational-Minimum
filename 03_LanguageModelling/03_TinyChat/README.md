...
```bash
python 03_LanguageModelling/03_TinyChat/src/test_dpo_loss.py
```
...
```bash
python 03_LanguageModelling/03_TinyChat/src/train_dpo.py --profile test
```
...
```bash
python 03_LanguageModelling/03_TinyChat/src/evaluate.py \

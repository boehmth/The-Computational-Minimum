...
```bash
python 03_LanguageModelling/02_TinyInstruct/src/test_masking.py
```
...
```bash
python 03_LanguageModelling/02_TinyInstruct/src/train_sft.py --profile test
```
...
```bash
python 03_LanguageModelling/02_TinyInstruct/src/evaluate.py \

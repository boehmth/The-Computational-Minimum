# 📖 3.3 Mixture of Experts — TinyMoE

## 🎯 Das Problem des Vorgängers

TinyChatGPT (3.2) ist ein **dichtes** Modell: Jedes einzelne Token durchläuft
...
*[Platzhalter — Vergleich TinyChatGPT (dicht) vs. TinyMoE bei gleicher
...
```
TinyChatGPT (dicht):   [Platzhalter] Parameter, alle aktiv pro Token
...
- Ein **Gating-Netzwerk**, das pro Token die Top-k Experten auswählt (z. B.
  ...
  Feed-Forward-Blocks wie in TinyChatGPT)
...
```bash
python 03_AgenticSystems/03_TinyMoE/src/train_moe.py --profile laptop
```
...
direkt, ohne sichtbare Zwischenschritte. Kapitel 3.4 (TinyReason) zeigt, wie

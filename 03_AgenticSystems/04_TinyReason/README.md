# 📖 3.4 Reasoning — TinyReason

## 🎯 Das Problem des Vorgängers

TinyChatGPT (3.2) und TinyMoE (3.3) folgen Instruktionen zuverlässig und
...
(3.3), wo Kapazität erstmals effizient skalierbar wurde, bis zu den Scaling
...
TinyChatGPT aus 3.2 (direkte, ggf. falsche Antwort) und einmal mit
...
TinyChatGPT (3.2):  [Platzhalter — direkte Antwort, ggf. fehlerhaft]
...
- Eine vereinfachte RL-Trainingsschleife: TinyChatGPT generiert mehrere
...
```bash
python 03_AgenticSystems/04_TinyReason/src/train_reason.py --profile laptop
```
...
Ergebnis extern überprüfen. Kapitel 3.5 zeigt, wie aus einem
reasoning-fähigen Modell ein erster handelnder Agent wird.
...
Die beiden Miniaturen oben zeigen die **Nachrichten-Form** von MCP und A2A — beide In-Prozess, damit die Struktur der Aufrufe im Vordergrund steht. Wer die Sache *wirklich* über das Netz laufen lassen will, findet unter [`src/a2a/`](src/a2a/README.md) einen eigenständig lauffähigen A2A-Server:

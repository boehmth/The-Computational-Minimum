...
Die zwei Miniaturen oben zeigen den **Wow-Moment**. Wer die Mechanik dahinter ganz sehen will — wie man von *"das Modell antwortet"* über *"strukturiertes JSON"* zu *"Tool-Registry mit Fehlerbehandlung"* kommt — findet unter [`src/mini_agent/`](src/mini_agent/README.md) eine Sechs-Schritt-Serie:
